...
const ServicesSection = () => {
  ...
  return (
    <section id="services" className="bg-[#f4f5f7] pt-16 text-[#1a1f2c] font-sans overflow-hidden">
      ...
      {/* How We Work Section */}
      <div className="pt-12 pb-32 bg-white relative">
        <div className="max-w-[1100px] mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {[
              ...
              <a key={item.step} href="#contact" className="block">
                <motion.div
                  initial={{ opacity: 0, y: 40 }}
                  whileInView={{ opacity: 1, y: 0 }}
                  viewport={{ once: true }}
