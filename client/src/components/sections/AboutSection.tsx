...
const AboutSection = () => {
  ...
  return (
    <section id="about" className="bg-slate-50 text-slate-900">
      <div className="pt-24 pb-8 bg-[#f4f5f7]">
      ...
      <div className="pt-20 pb-10 bg-slate-50 overflow-hidden">
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4 max-w-6xl mx-auto">
            {[
              ...
              >
                ...
                <a href="#contact" className={`mt-8 flex items-center text-sm font-semibold transition-colors relative z-10 cursor-pointer ${item.color} opacity-0 -translate-x-2 group-hover:opacity-100 group-hover:translate-x-0 duration-300`}>
