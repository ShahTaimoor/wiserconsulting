  ...
  ({ className, children, ...props }, ref) => {
    return (
      <button
        ref={ref}
        className={cn(
          "group relative px-[35px] py-[12px] text-[17px] font-medium text-[#181818] bg-[#fec195] border-[3px] border-[#fec195] rounded-md shadow-[0_0_0_#fec1958c] transition-all duration-300 ease-in-out cursor-pointer hover:bg-transparent hover:text-[#fec195] hover:shadow-[0_0_25px_#fec1958c] active:scale-95 flex items-center justify-center gap-2",
          className
        )}
        {...props}
      >
